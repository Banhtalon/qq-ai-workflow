...
Mỗi lượt thực thi phải phân biệt `role`, `provider`, `cli`, `requested_model`, `observed_models` và `session_id`. Antigravity là CLI worker hiện tại cho provider Google; Codex là CLI hiện tại cho các vai trò review/senior. Model thực tế phải lấy từ probe hoặc metadata do CLI/provider báo cáo, không suy đoán từ tên CLI.
