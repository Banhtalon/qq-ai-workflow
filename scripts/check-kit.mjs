...
import {assertCurrentVersionFiles} from "./lib/version-consistency.mjs";
...
const versionCheck=await assertCurrentVersionFiles(root);
...
console.log(`PASS: current version ${versionCheck.version}; active profile, entry points, documentation links and reference fixtures`);
